...
const DiscountProducts = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-4 lg:gap-[35px] items-center justify-center mb-24 md:mb-32 lg:mb-48">
      <Link
        to="#"
        className="relative lg:top-10 flex justify-center items-center w-full h-auto md:h-[633px] lg:h-[633px]"
      >
        <img
      ...
      <Link
        to="#"
        className="relative lg:bottom-4 flex justify-center items-center w-full h-auto md:h-[509px] lg:h-[509px]"
      >
        <img
      ...
      <Link
        to="#"
        className="relative flex justify-center items-center w-full h-auto md:h-[509px] lg:h-[509px]"
      >
        <img
      ...
      <Link
        to="#"
        className="relative lg:bottom-14 flex justify-center items-center w-full h-auto md:h-[633px] lg:h-[633px]"
      >
        <img
