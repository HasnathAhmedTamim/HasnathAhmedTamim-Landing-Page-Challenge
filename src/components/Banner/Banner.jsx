      ...
      >
        <SwiperSlide>
          <div className=" flex flex-col lg:flex-row items-center h-full p-8">
            {/* left div */}
            <div className="text-center lg:text-left p-4  relative left-14 z-20">
            ...
            {/* right div */}
            <div className="relative lg:w-1/2 flex items-center justify-end   right-14">
              <div
              ...
              ></div>
              <img className="relative z-10" src={slide1} alt="Slide 1" />
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
